...
export class AddressAutocomplete implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    private GOOGLE_API_KEY:string = 'AIzaSyCS02GPaOUIyRe8s4q0H-S2XTN2OJEaDkU';
    constructor() {
    ...
    public init(context: ComponentFramework.Context<IInputs>,
        ...
        let scriptUrl = "https://maps.googleapis.com/maps/api/js?libraries=places&language=en&key=" + this.GOOGLE_API_KEY;
